...
const char DESTINATION_IP[] = "192.168.1.100";
...
int network_connect()
{
    ...
    //bcopy((char *) DESTINATION_IP,
//		    (char *)&address.sin_addr.s_addr, strlen(DESTINATION_IP));
    address.sin_family = AF_INET;
    address.sin_port = htons( (unsigned short) UDP_PORT );
    int res = connect(handle,(const sockaddr *)&address,sizeof(sockaddr_in)); 
    if (res < 0){
